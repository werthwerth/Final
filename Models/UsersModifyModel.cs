...
namespace Final.Models
{
    public class UsersModifyModel : BaseModel
    {
        ...
        public UsersModifyModel(string _sessionId, DB _db, RouteData _routes, string FirstName, string LastName, string Email, string? Password, List<Role?>? _roleList) : base(_sessionId, _db)
        {
            Access = AccessScripts.CheckAccess(_db, base.user, _routes);
